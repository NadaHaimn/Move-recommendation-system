...
# تحميل البيانات
movies = pickle.load(open('E:\Move-recommendation-system\models\movies.pkl', 'rb'))
similarity = pickle.load(open('E:\Move-recommendation-system\models\similarity.pkl', 'rb'))
